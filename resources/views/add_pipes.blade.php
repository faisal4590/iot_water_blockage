        ...
        <main class="flex-1">
            <div class="py-6">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                    <h1 class="text-2xl font-semibold text-gray-900">Add Pipe</h1>
                </div>
                <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                        ...
                        <div class="mt-8">
                            <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                                <div class="mt-2 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                                    <form action="{{ route('pipe.store') }}" method="POST">
                                        @csrf
                                        {{-- type --}}
                                        <div>
                                        ...
                                        {{-- full_address --}}
                                        <div>
                                            <label for="password" class="block text-sm font-medium text-gray-700"> Full Address </label>
                                            <div class="mt-1">
                                        ...
                                        {{-- diameter --}}
                                        <div>
                                            <label for="name" class="block text-sm font-medium text-gray-700"> Diameter </label>
                                            <div class="mt-1">
                                        ...
                                        <div>
                                            <label for="name" class="block text-sm font-medium text-gray-700"> Overseeing Authority </label>
                                            <div class="mt-1">
                                                <input id="overseeing_authority" name="overseeing_authority" type="text"
                                                       required
                                                       class="appearance-none block w-full px-3 py-2
                                                        border border-gray-300 rounded-md shadow-sm
                                                        placeholder-gray-400 focus:outline-none
                                        ...
                                        {{-- drainage importance level --}}
                                        <div>
                                            <label for="name" class="block text-sm font-medium text-gray-700"> Drainage Importance Level </label>
                                            <div class="mt-1">
                                                <input id="drainage_importance_level" name="drainage_importance_level" type="text"
                                                       required
                                                       class="appearance-none block w-full px-3 py-2
                                                        border border-gray-300 rounded-md shadow-sm
                                                        placeholder-gray-400 focus:outline-none
